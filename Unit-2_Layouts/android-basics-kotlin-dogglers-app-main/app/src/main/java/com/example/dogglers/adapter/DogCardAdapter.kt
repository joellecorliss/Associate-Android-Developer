...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        when(layout) {
            Layout.GRID -> selectedLayout = R.layout.grid_list_item
            Layout.VERTICAL -> selectedLayout = R.layout.vertical_horizontal_list_item
            Layout.HORIZONTAL -> selectedLayout = R.layout.vertical_horizontal_list_item
        }
...
//        }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dogAgeTextView?.text = context?.resources?.getString(R.string.dog_age, dog.age)
        ...
        if (resources != null) {
            holder.dogHobbyTextView?.text = resources.getString(R.string.dog_hobbies, dog.hobbies)
        }
