...
class OrderViewModel : ViewModel() {
    ...
    // Subtotal for the order - use transformation if you want to convert to another data type
    ...
    fun setEntree(entree: String) {
        ...
        if (_subtotal.value != null) {
            //if written as _subtotal.value?.minus(previousEntreePrice), the subtotal in the screen remains $0.00
